...
@class NSString, NSAttributedString, CPTPlotSpace, NSMutableDictionary, CPTTextStyle, NSFormatter, CPTShadow, NSMutableArray, CPTPlotArea, NSArray;
...
-(SCD_Struct_CP82)cachedDecimalForField:(unsigned)arg1 recordIndex:(unsigned)arg2 ;
