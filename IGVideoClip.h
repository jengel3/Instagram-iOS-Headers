...
@interface IGVideoClip : NSObject <NSCopying> {
	...
	CGRect _cropRect;
	SCD_Struct_IG43 _startTime;
	SCD_Struct_IG43 _endTime;
	SCD_Struct_IG45 _compositionTimeRange;
...
@property (assign,nonatomic) SCD_Struct_IG43 startTime;                                //@synthesize startTime=_startTime - In the implementation block
@property (assign,nonatomic) SCD_Struct_IG43 endTime;                                  //@synthesize endTime=_endTime - In the implementation block
@property (nonatomic,readonly) SCD_Struct_IG45 timeRangeForAudioAndVideo; 
@property (nonatomic,readonly) float trimmedDuration; 
@property (assign,nonatomic) SCD_Struct_IG45 compositionTimeRange;                     //@synthesize compositionTimeRange=_compositionTimeRange - In the implementation block
...
-(SCD_Struct_IG45)timeRangeForAudioAndVideo;
-(CGSize)applyInverseTransformToSize:(CGSize)arg1 ;
-(SCD_Struct_IG45)compositionTimeRange;
-(void)setCompositionTimeRange:(SCD_Struct_IG45)arg1 ;
-(_GLKMatrix4)playbackTransform;
-(CGRect)cropRect;
-(void)setCropRect:(CGRect)arg1 ;
-(void)dealloc;
-(void)setStartTime:(SCD_Struct_IG43)arg1 ;
...
-(void)setEndTime:(SCD_Struct_IG43)arg1 ;
