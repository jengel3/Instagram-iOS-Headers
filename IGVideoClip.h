...
@interface IGVideoClip : NSObject <NSSecureCoding, NSCopying> {
	...
	SCD_Struct_IG53 _endTime;
	SCD_Struct_IG68 _compositionTimeRange;
...
@property (assign,nonatomic) SCD_Struct_IG53 endTime;                           //@synthesize endTime=_endTime - In the implementation block
@property (assign,nonatomic) int trimType;                                      //@synthesize trimType=_trimType - In the implementation block
@property (assign,nonatomic) SCD_Struct_IG68 compositionTimeRange;              //@synthesize compositionTimeRange=_compositionTimeRange - In the implementation block
...
-(SCD_Struct_IG68)compositionTimeRange;
...
-(SCD_Struct_IG68)timeRangeForAudioAndVideo;
-(void)setCompositionTimeRange:(SCD_Struct_IG68)arg1 ;
