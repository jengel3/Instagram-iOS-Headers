...
@class UIViewController, NSMutableArray, NSString, UIImage, NSArray, FBSDKAccessToken;
...
-(void)welcomeController:(id)arg1 proceedRegisteringWithFBInfo:(id)arg2 facebookAccessToken:(id)arg3 ;
