...
@interface IGCommentThreadViewController2 : IGViewController <IGListAdapterDataSource, UICollectionViewDelegateFlowLayout, IGCommentThreadManagerDelegate, IGCommentLoadItemDelegate, IGBulkCommentDeleteManagerDelegate, IGGrowingTextViewDelegate, IGCommentItemDelegate> {
