...
@interface IGClusterAnnotationViewLayout : NSObject {
	...
	SCD_Struct_IG117 _largeRows;
	SCD_Struct_IG117 _smallRows;

}

@property (assign,nonatomic) SCD_Struct_IG117 largeRows;              //@synthesize largeRows=_largeRows - In the implementation block
@property (assign,nonatomic) SCD_Struct_IG117 smallRows;              //@synthesize smallRows=_smallRows - In the implementation block
...
-(SCD_Struct_IG117)largeRows;
-(void)setLargeRows:(SCD_Struct_IG117)arg1 ;
-(SCD_Struct_IG117)smallRows;
-(void)setSmallRows:(SCD_Struct_IG117)arg1 ;
-(float)totalWidth;
