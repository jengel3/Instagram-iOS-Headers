...
@property (assign,nonatomic) SCD_Struct_IG57 keyTime;                                          //@synthesize keyTime=_keyTime - In the implementation block
...
-(void)playbackView:(id)arg1 didPlayToTime:(SCD_Struct_IG57)arg2 ;
...
-(void)setKeyTime:(SCD_Struct_IG57)arg1 ;
-(void)populateThumbnailCacheForClipIndex:(unsigned)arg1 ;
-(void)cacheThumbnail:(id)arg1 forClip:(id)arg2 andTime:(SCD_Struct_IG57)arg3 ;
-(id)cacheKeyForClip:(id)arg1 filter:(id)arg2 time:(SCD_Struct_IG57)arg3 ;
-(SCD_Struct_IG57)keyTime;
