...
@class IGButton, UIView, IGCommentModel, IGCommentThreadTableSource, IGAutocompleteController, IGBulkMediaRequestManager, IGFeedItem, IGGrowingTextView, IGPlainTableView, IGUserPreviewingHandler, NSString;
