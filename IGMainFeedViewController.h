...
@class UIView, UIImageView, IGInboxButton, NSArray, IGFeedPhotoPromptView, IGFeedFollowPeopleCell, NSDictionary, IGGenericMegaphoneView, FBAnimationPerformanceTracker, IGDogfooderMegaphoneHelper, IGInlineGalleryViewController, NSString;

@interface IGMainFeedViewController : IGFeedViewController <IGMainFeedUploadCellContentViewDelegate, IGFeedFollowPeopleCellDelegate, IGGenericMegaphoneViewDelegate, FBAnimationPerformanceTrackerDelegate, IGDogfooderMegaphoneHelperDelegate, IGFeedNetworkSourceDelegate> {
	...
	IGGenericMegaphoneView* _dogfooderMegaphone;
...
@property (nonatomic,retain) IGGenericMegaphoneView * dogfooderMegaphone;                          //@synthesize dogfooderMegaphone=_dogfooderMegaphone - In the implementation block
...
-(IGGenericMegaphoneView *)dogfooderMegaphone;
-(IGDogfooderMegaphoneHelper *)dogfooderMegaphoneHelper;
-(void)setDogfooderMegaphone:(IGGenericMegaphoneView *)arg1 ;
...
-(void)presentInlineGalleryWithDelegate:(id)arg1 animated:(char)arg2 ;
-(void)dismissInlineGalleryAnimated:(char)arg1 ;
