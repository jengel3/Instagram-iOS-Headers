...
@class NSArray, IGFeedPhotoPromptView, IGFeedFollowPeopleCell, NSDictionary, IGGenericMegaphoneView, FBAnimationPerformanceTracker, IGDogfooderMegaphoneHelper, NSString;

@interface IGMainFeedViewController : IGFeedViewController_DEPRECATED <IGMainFeedUploadCellContentViewDelegate, IGFeedFollowPeopleCellDelegate, IGGenericMegaphoneViewDelegate, FBAnimationPerformanceTrackerDelegate, IGDogfooderMegaphoneHelperDelegate, IGFeedNetworkSourceDelegate> {
