...
+(id)periodWithStartDecimal:(SCD_Struct_CP81)arg1 endDecimal:(SCD_Struct_CP81)arg2 duration:(float)arg3 withDelay:(float)arg4 ;
...
-(id)initWithStartDecimal:(SCD_Struct_CP81)arg1 endDecimal:(SCD_Struct_CP81)arg2 duration:(float)arg3 withDelay:(float)arg4 ;
