...
@class NSURL, NSData, IGUploadModel, IGPhoto, IGDirectContentUploadInfo, NSString, NSArray;

@interface IGDirectPhoto : IGDirectContent <IGDirectCommentable, IGDirectContentFirstAppearance, IGDirectContentMediaUploadable, IGDirectContentReactable, IGDirectMediaContent, NSCoding> {
