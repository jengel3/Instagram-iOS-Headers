...
@protocol IGDirectContentCellDelegate, IGDirectContentCellShareDelegate, IGDirectContentCellTextLinkDelegate, IGDirectContentCellDecorator;
...
@interface IGPublicThreadContentCell : UICollectionViewCell <IGProfilePictureImageViewDelegate, UIGestureRecognizerDelegate, IGSlidingCollectionViewCell, IGDirectCellProtocol> {
	...
	id<IGDirectContentCellShareDelegate> _shareDelegate;
...
@property (assign,nonatomic,__weak) id<IGDirectContentCellShareDelegate> shareDelegate;                  //@synthesize shareDelegate=_shareDelegate - In the implementation block
...
-(id<IGDirectContentCellShareDelegate>)shareDelegate;
-(void)setShareDelegate:(id<IGDirectContentCellShareDelegate>)arg1 ;
