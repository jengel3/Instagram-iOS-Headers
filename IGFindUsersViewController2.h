...
@interface IGFindUsersViewController2 : IGViewController <IGFindFriendsHelperDelegate, IGFindUsersViewDataSourceDelegate, IGPullToRefreshProtocol, IGListAdapterDataSource, IGListAdapterDelegate, IGRaindropAnalyticsDelegate, UICollectionViewDelegate, IGFeedStatusViewDelegate> {
