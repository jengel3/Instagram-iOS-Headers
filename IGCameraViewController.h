...
@property (assign,nonatomic) int cameraType;                                                  //@synthesize cameraType=_cameraType - In the implementation block
...
-(void)moveShutterBarOffscreen:(char)arg1 animated:(char)arg2 ;
-(void)enterCameraPermissionDeniedState;
-(void)onAppWillBackground;
-(void)onAppForegrounded;
-(void)updateStabilizationSampler;
-(void)updateUIToDeviceOrientationAnimated:(char)arg1 ;
...
-(char)shouldShowGridButton;
-(char)shouldShowSwitchCamerasButton;
-(char)shouldShowFlashButton;
