...
@interface IGTrackStabilizer : NSObject {
	...
	SCD_Struct_IG68 _calibrationParameters;

}

@property (nonatomic,readonly) int cameraPosition;                                 //@synthesize cameraPosition=_cameraPosition - In the implementation block
@property (nonatomic,readonly) SCD_Struct_IG68 calibrationParameters;              //@synthesize calibrationParameters=_calibrationParameters - In the implementation block
...
-(unsigned long)frameIndexForPresentationTime:(SCD_Struct_IG43)arg1 ;
-(id)warpForFrameIndex:(unsigned long)arg1 ;
-(double)stabilizationZoom;
-(id)initWithCameraPosition:(int)arg1 calibrationParameters:(SCD_Struct_IG68)arg2 gyroTrack:(id)arg3 frameTrack:(id)arg4 frameSkipFactor:(int)arg5 maxZoom:(float)arg6 iterations:(int)arg7 ;
-(void)stabilize;
-(NSData *)frameData;
