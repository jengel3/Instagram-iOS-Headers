...
@property (assign,nonatomic) char shouldShowFollowButtons;                                   //@synthesize shouldShowFollowButtons=_shouldShowFollowButtons - In the implementation block
...
-(void)setShouldShowFollowButtons:(char)arg1 ;
