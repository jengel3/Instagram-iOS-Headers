...
@interface CPTPlotRange : NSObject <NSCoding, NSCopying, NSMutableCopying> {
	...
	double lengthDouble;
	SCD_Struct_CP126 locationDecimal;
	SCD_Struct_CP126 lengthDecimal;
...
@property (nonatomic,readonly) SCD_Struct_CP126 endDecimal; 
...
@property (nonatomic,readonly) SCD_Struct_CP126 minLimitDecimal; 
@property (nonatomic,readonly) SCD_Struct_CP126 midPointDecimal; 
@property (nonatomic,readonly) SCD_Struct_CP126 maxLimitDecimal; 
...
+(id)plotRangeWithLocationDecimal:(SCD_Struct_CP126)arg1 lengthDecimal:(SCD_Struct_CP126)arg2 ;
-(double)locationDouble;
-(double)lengthDouble;
-(SCD_Struct_CP126)minLimitDecimal;
-(SCD_Struct_CP126)maxLimitDecimal;
...
-(SCD_Struct_CP126)locationDecimal;
-(void)setLocationDecimal:(SCD_Struct_CP126)arg1 ;
-(void)setLengthDecimal:(SCD_Struct_CP126)arg1 ;
-(int)compareToDecimal:(SCD_Struct_CP126)arg1 ;
-(SCD_Struct_CP126)endDecimal;
...
-(id)initWithLocationDecimal:(SCD_Struct_CP126)arg1 lengthDecimal:(SCD_Struct_CP126)arg2 ;
-(char)inValueUpdate;
-(SCD_Struct_CP126)midPointDecimal;
...
-(char)contains:(SCD_Struct_CP126)arg1 ;
@end
