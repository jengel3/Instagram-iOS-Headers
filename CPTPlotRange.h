...
@interface CPTPlotRange : NSObject <NSCoding, NSCopying, NSMutableCopying> {
	...
	double lengthDouble;
	SCD_Struct_CP85 locationDecimal;
	SCD_Struct_CP85 lengthDecimal;
...
@property (nonatomic,readonly) SCD_Struct_CP85 endDecimal; 
...
@property (nonatomic,readonly) SCD_Struct_CP85 minLimitDecimal; 
@property (nonatomic,readonly) SCD_Struct_CP85 midPointDecimal; 
@property (nonatomic,readonly) SCD_Struct_CP85 maxLimitDecimal; 
...
+(id)plotRangeWithLocationDecimal:(SCD_Struct_CP85)arg1 lengthDecimal:(SCD_Struct_CP85)arg2 ;
+(id)plotRangeWithLocation:(id)arg1 length:(id)arg2 ;
-(double)locationDouble;
-(double)lengthDouble;
-(SCD_Struct_CP85)minLimitDecimal;
-(SCD_Struct_CP85)maxLimitDecimal;
...
-(SCD_Struct_CP85)locationDecimal;
-(void)setLocationDecimal:(SCD_Struct_CP85)arg1 ;
-(void)setLengthDecimal:(SCD_Struct_CP85)arg1 ;
-(int)compareToDecimal:(SCD_Struct_CP85)arg1 ;
-(SCD_Struct_CP85)endDecimal;
...
-(id)initWithLocationDecimal:(SCD_Struct_CP85)arg1 lengthDecimal:(SCD_Struct_CP85)arg2 ;
-(char)inValueUpdate;
-(SCD_Struct_CP85)midPointDecimal;
...
-(char)contains:(SCD_Struct_CP85)arg1 ;
@end
