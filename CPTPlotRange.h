...
@interface CPTPlotRange : NSObject <NSCoding, NSCopying, NSMutableCopying> {
	...
	double lengthDouble;
	SCD_Struct_CP82 locationDecimal;
	SCD_Struct_CP82 lengthDecimal;
...
@property (nonatomic,readonly) SCD_Struct_CP82 endDecimal; 
...
@property (nonatomic,readonly) SCD_Struct_CP82 minLimitDecimal; 
@property (nonatomic,readonly) SCD_Struct_CP82 midPointDecimal; 
@property (nonatomic,readonly) SCD_Struct_CP82 maxLimitDecimal; 
...
+(id)plotRangeWithLocationDecimal:(SCD_Struct_CP82)arg1 lengthDecimal:(SCD_Struct_CP82)arg2 ;
+(id)plotRangeWithLocation:(id)arg1 length:(id)arg2 ;
-(double)locationDouble;
-(double)lengthDouble;
-(SCD_Struct_CP82)minLimitDecimal;
-(SCD_Struct_CP82)maxLimitDecimal;
...
-(SCD_Struct_CP82)locationDecimal;
-(void)setLocationDecimal:(SCD_Struct_CP82)arg1 ;
-(void)setLengthDecimal:(SCD_Struct_CP82)arg1 ;
-(int)compareToDecimal:(SCD_Struct_CP82)arg1 ;
-(SCD_Struct_CP82)endDecimal;
...
-(id)initWithLocationDecimal:(SCD_Struct_CP82)arg1 lengthDecimal:(SCD_Struct_CP82)arg2 ;
-(char)inValueUpdate;
-(SCD_Struct_CP82)midPointDecimal;
...
-(char)contains:(SCD_Struct_CP82)arg1 ;
@end
