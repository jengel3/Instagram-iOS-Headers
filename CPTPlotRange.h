...
@interface CPTPlotRange : NSObject <NSCoding, NSCopying, NSMutableCopying> {
	...
	double lengthDouble;
	SCD_Struct_CP80 locationDecimal;
	SCD_Struct_CP80 lengthDecimal;
...
@property (nonatomic,readonly) SCD_Struct_CP80 endDecimal; 
...
@property (nonatomic,readonly) SCD_Struct_CP80 minLimitDecimal; 
@property (nonatomic,readonly) SCD_Struct_CP80 midPointDecimal; 
@property (nonatomic,readonly) SCD_Struct_CP80 maxLimitDecimal; 
...
+(id)plotRangeWithLocationDecimal:(SCD_Struct_CP80)arg1 lengthDecimal:(SCD_Struct_CP80)arg2 ;
-(double)locationDouble;
-(double)lengthDouble;
-(SCD_Struct_CP80)minLimitDecimal;
-(SCD_Struct_CP80)maxLimitDecimal;
...
-(SCD_Struct_CP80)locationDecimal;
-(void)setLocationDecimal:(SCD_Struct_CP80)arg1 ;
-(void)setLengthDecimal:(SCD_Struct_CP80)arg1 ;
-(int)compareToDecimal:(SCD_Struct_CP80)arg1 ;
-(SCD_Struct_CP80)endDecimal;
...
-(id)initWithLocationDecimal:(SCD_Struct_CP80)arg1 lengthDecimal:(SCD_Struct_CP80)arg2 ;
-(char)inValueUpdate;
-(SCD_Struct_CP80)midPointDecimal;
...
-(char)contains:(SCD_Struct_CP80)arg1 ;
@end
