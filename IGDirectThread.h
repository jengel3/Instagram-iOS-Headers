...
@class NSString, NSOrderedSet, NSArray, IGUser, IGDate, NSDictionary, IGDirectContent;
...
@property (nonatomic,retain) IGDate * lastSeenAt;                                           //@synthesize lastSeenAt=_lastSeenAt - In the implementation block
...
+(int)threadTypeFromString:(id)arg1 ;
...
-(void)setLastSeenAt:(IGDate *)arg1 ;
