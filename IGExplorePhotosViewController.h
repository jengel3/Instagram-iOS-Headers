...
@class IGExploreSearchViewController, NSMutableSet, NSArray, IGExplorePeopleBannerView, IGExploreJumbotronView, IGExploreCarouselsView, IGRelatedItemsHeaderView, IGExploreSectionTextHeader, IGExploreTTILogger, NSDate, NSString, IGExploreTrend, IGFeedThumbnailPreviewingHandler, FBAnimationPerformanceTracker, IGExplorePhotosNetworkSource;
...
@interface IGExplorePhotosViewController : IGFeedViewController <IGExploreSearchControllerDelegate, FBAnimationPerformanceTrackerDelegate, IGSearchOriginControllerProtocol> {
	...
	IGRelatedItemsHeaderView* _textCarouselView;
...
-(IGRelatedItemsHeaderView *)textCarouselView;
-(IGExploreTrend *)trendPlace;
-(void)setTextCarouselView:(IGRelatedItemsHeaderView *)arg1 ;
