...
@interface IGResetPasswordViewController : IGGroupedTableViewController <IGRetroRegistrationSMSVerificationViewControllerDelegate, IGRetroRegistrationTwoFactorContactFormDelegate, IGTextFieldDelegate> {
...
-(void)logOutAndSignInWithResponse:(id)arg1 isTwoFactorRequired:(char)arg2 twoFactorInfo:(id)arg3 ;
