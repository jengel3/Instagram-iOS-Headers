...
@class IGKVOHandle, IGVideoComposition, IGMediaMetadata, UIViewController, IGBroadcastShareManager, IGDirectShareManagerViewController, IGShareToggle, IGCaptionCell, IGAutocompleteController, UIView, IGShareButton, IGCameraNavigationController, NSString;
...
@interface IGShareViewController : IGViewController <IGCaptionCellDelegate, IGAutocompleteControllerDelegate, IGCaptionCellDelegate, IGCameraViewControllerProtocol> {
	...
	IGDirectShareManagerViewController* _directShareManager;
...
@property (nonatomic,retain) IGDirectShareManagerViewController * directShareManager;              //@synthesize directShareManager=_directShareManager - In the implementation block
...
-(IGDirectShareManagerViewController *)directShareManager;
-(void)setDirectShareManager:(IGDirectShareManagerViewController *)arg1 ;
