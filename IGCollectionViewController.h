...
@property (assign,getter=hasFlippedScrollIndicator,nonatomic) char flippedScrollIndicator;              //@synthesize flippedScrollIndicator=_flippedScrollIndicator - In the implementation block
...
-(void)reloadWithNewObjects:(id)arg1 context:(id)arg2 synchronus:(char)arg3 completionBlock:(/*^block*/id)arg4 ;
...
-(char)hasFlippedScrollIndicator;
...
-(void)setFlippedScrollIndicator:(char)arg1 ;
