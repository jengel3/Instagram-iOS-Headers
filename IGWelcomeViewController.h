...
@interface IGWelcomeViewController : IGViewController <IGSignUpViewDelegate, IGLogInViewDelegate, IGLogInViewOnePasswordDelegate, IGRetroRegistrationSMSVerificationViewControllerDelegate, IGResetPasswordDelegate, IGRetroRegistrationTwoFactorContactFormDelegate> {
