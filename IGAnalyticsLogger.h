...
@class IGTimeSpent, IGCounterEvent, IGTimerEvent, IGAverageEvent, NSObject, IGAnalyticsLogFileManager, NSString, NSMutableArray, IGAnalyticsSession;
...
@interface IGAnalyticsLogger : NSObject <IGEventAggregatorDelegate> {
	...
	NSMutableArray* _binaryLoggedEvents;
