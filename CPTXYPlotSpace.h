...
-(CGPoint)plotAreaViewPointForPlotPoint:(SCD_Struct_CP82*)arg1 numberOfCoordinates:(unsigned)arg2 ;
...
-(void)plotPoint:(SCD_Struct_CP82*)arg1 numberOfCoordinates:(unsigned)arg2 forPlotAreaViewPoint:(CGPoint)arg3 ;
...
-(void)plotPoint:(SCD_Struct_CP82*)arg1 numberOfCoordinates:(unsigned)arg2 forEvent:(UIEvent*)arg3 ;
...
-(float)viewCoordinateForViewLength:(SCD_Struct_CP82)arg1 linearPlotRange:(id)arg2 plotCoordinateValue:(SCD_Struct_CP82)arg3 ;
...
-(SCD_Struct_CP82)plotCoordinateForViewLength:(SCD_Struct_CP82)arg1 linearPlotRange:(id)arg2 boundsLength:(SCD_Struct_CP82)arg3 ;
...
-(double)lastDragTime;
-(double)lastDeltaTime;
-(void)animateRangeForCoordinate:(int)arg1 shift:(SCD_Struct_CP82)arg2 momentumTime:(float)arg3 speed:(float)arg4 acceleration:(float)arg5 ;
-(id)shiftRange:(id)arg1 by:(SCD_Struct_CP82)arg2 usingMomentum:(char)arg3 inGlobalRange:(id)arg4 withDisplacement:(float*)arg5 ;
