...
@class IGAnalyticsMetadata, IGFeedItem, NSArray, IGFeedHeartAnimator, IGUser, IGFeedVideoCellManager, IGListAdapterScrollingContext, IGFeedDirectResponseHandler, IGFeedItemTimelineViewModel, IGFeedItemPageCellState, IGAlbumFocusCoordinator, IGCameraNavigationControllerTransitionDelegate, IGFeedItemHeader, IGImagePreparer, IGTranslationNetworkDataSource, NSString;

@interface IGFeedItemController : IGListItemController <IGActionSheetDelegate, IGAlbumFullscreenViewControllerDelegate, IGFeedItemActionCellConfigurableDelegate, IGFeedItemAlbumCellDelegate, IGFeedItemHeaderDelegate, IGFeedItemPageCellDelegate, IGFeedItemPhotoCellDelegate, IGFeedItemTextCellDelegate, IGFeedVideoCellInteractionDelegate, IGListDisplayDelegate, IGListSupplementaryViewSource, IGRaindropAnalyticsDelegate, IGUserInTagDisplayDelegate, IGFeedItemBusinessCellDelegate, IGFeedItemHiddenConfirmationCellDelegate, IGListWorkingRangeDelegate, IGMediaRequestDelegate, IGTranslationNetworkDataSourceDelegate, IGListItemType> {
