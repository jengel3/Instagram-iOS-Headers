...
+(char)isOSRunTimeVersionAtLeast:(SCD_Struct_FB95)arg1 ;
+(id)bundleForStrings;
+(char)shouldManuallyAdjustOrientation;
+(int)_compareOperatingSystemVersion:(SCD_Struct_FB95)arg1 toVersion:(SCD_Struct_FB95)arg2 ;
...
+(SCD_Struct_FB95)operatingSystemVersion;
+(id)appURLScheme;
-(id)init;
@end
