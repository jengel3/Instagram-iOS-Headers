...
+(char)isOSRunTimeVersionAtLeast:(SCD_Struct_IG26)arg1 ;
+(id)bundleForStrings;
+(char)shouldManuallyAdjustOrientation;
+(int)_compareOperatingSystemVersion:(SCD_Struct_IG26)arg1 toVersion:(SCD_Struct_IG26)arg2 ;
...
+(SCD_Struct_IG26)operatingSystemVersion;
+(id)appURLScheme;
-(id)init;
@end
