...
@interface IGVideoTrimView : UIControl <UIScrollViewDelegate> {
	...
	SCD_Struct_IG57 _scrubTime;
	SCD_Struct_IG57 _playbackTime;
	SCD_Struct_IG57 _beforeTrimStartTime;
	SCD_Struct_IG57 _beforeTrimEndTime;
...
@property (nonatomic,readonly) SCD_Struct_IG57 startTime; 
@property (nonatomic,readonly) SCD_Struct_IG57 endTime; 
@property (assign,nonatomic) SCD_Struct_IG57 scrubTime;                        //@synthesize scrubTime=_scrubTime - In the implementation block
@property (assign,nonatomic) char scrubbing;                                   //@synthesize scrubbing=_scrubbing - In the implementation block
@property (assign,nonatomic) SCD_Struct_IG57 playbackTime;                     //@synthesize playbackTime=_playbackTime - In the implementation block
@property (assign,nonatomic) SCD_Struct_IG57 beforeTrimStartTime;              //@synthesize beforeTrimStartTime=_beforeTrimStartTime - In the implementation block
@property (assign,nonatomic) SCD_Struct_IG57 beforeTrimEndTime;                //@synthesize beforeTrimEndTime=_beforeTrimEndTime - In the implementation block
...
-(SCD_Struct_IG57)beforeTrimStartTime;
-(SCD_Struct_IG57)beforeTrimEndTime;
-(SCD_Struct_IG57)scrubTime;
-(char)scrubbing;
...
-(void)setScrubTime:(SCD_Struct_IG57)arg1 ;
-(void)setPlaybackTime:(SCD_Struct_IG57)arg1 forceUpdate:(char)arg2 ;
-(void)setScrubbingFrames:(char)arg1 ;
-(void)setBeforeTrimStartTime:(SCD_Struct_IG57)arg1 ;
-(void)setBeforeTrimEndTime:(SCD_Struct_IG57)arg1 ;
...
-(SCD_Struct_IG57)playbackTime;
-(void)setPlaybackTime:(SCD_Struct_IG57)arg1 ;
