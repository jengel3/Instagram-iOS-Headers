...
@class UIBarButtonItem, IGUserDetailHeaderView, IGUser, IGFriendRequestHeaderView, IGNuxTapOnCameraView, UIView, UILabel, NSDictionary, IGPostsFeedVisibleStatus, IGSwitchUsersController, IGCaretView, NSString;
