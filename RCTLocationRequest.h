...
@property (assign,nonatomic) SCD_Struct_RC136 options;              //@synthesize options=_options - In the implementation block
...
-(void)dealloc;
-(void)setOptions:(SCD_Struct_RC136)arg1 ;
-(SCD_Struct_RC136)options;
