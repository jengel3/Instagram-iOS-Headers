...
@class IGUserSession, IGInviteFriendsDataSource, NSMutableArray, IGListAdapter, IGListAdapterPerfLogger, IGListCollectionView, NSString;

@interface IGInviteFBFriendsViewController : IGViewController <UICollectionViewDelegate, UIScrollViewDelegate, IGInviteFriendsDataSourceDelegate, IGListAdapterDataSource, IGListAdapterDelegate> {
