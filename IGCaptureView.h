...
@class AVCaptureVideoPreviewLayer, IGMediaCaptureButton, IGTapButton, IGVideoProgressView, IGVideoCaptureDeleteButton, IGCameraFocusIndicator, UITapGestureRecognizer, UILongPressGestureRecognizer, UIView, UIScrollView, IGCameraAccessPromptView, NSString;
