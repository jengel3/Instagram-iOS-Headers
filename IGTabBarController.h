...
@class IGTabBar, IGTabBarButton, NSArray, IGToastViewPopup, IGToastData, IGSwitchUsersController, UIWindow, IGDimmedOverlayViewController, IGInlineGalleryViewController, IGAlbumTabBarEntryController, IGExplorePromptTooltipPresenter, IGNavigationController, IGNewsViewController, UIViewController, UIView, NSString;
