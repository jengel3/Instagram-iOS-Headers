...
@class IGTabBar, IGTabBarButton, NSArray, IGToastViewPopup, IGToastData, IGUnreadBubbleView, IGSwitchUsersController, UIWindow, IGDimmedOverlayViewController, UIViewController, UIView, IGNavigationController, IGNewsViewController, NSString;
