...
@class IGTabBar, IGTabBarButton, NSArray, IGToastViewPopup, IGToastData, IGSwitchUsersController, UIWindow, IGDimmedOverlayViewController, IGMainFeedViewController, UIViewController, UIView, IGNavigationController, IGNewsViewController, NSString;
...
@interface IGTabBarController : UIViewController <IGToastViewDelegate, UIGestureRecognizerDelegate, IGSwitchUsersControllerDelegate, IGDimmedOverlayViewControllerDelegate, IGInlineGalleryPresenter> {
	...
	IGMainFeedViewController* _timelineController;
...
@property (nonatomic,retain) IGMainFeedViewController * timelineController;                            //@synthesize timelineController=_timelineController - In the implementation block
...
-(IGMainFeedViewController *)timelineController;
...
-(CGPoint)referencePointForInlineGallery:(id)arg1 ;
...
-(void)setTimelineController:(IGMainFeedViewController *)arg1 ;
-(void)dealloc;
-(id)init;
