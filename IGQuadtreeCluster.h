...
@interface IGQuadtreeCluster : NSObject {
	...
	SCD_Struct_IG30 _centerCoordinate;
...
@property (assign,nonatomic) SCD_Struct_IG30 centerCoordinate;              //@synthesize centerCoordinate=_centerCoordinate - In the implementation block
...
-(int)numPoints;
-(SCD_Struct_IG32)boundingRegion;
-(id)init;
...
-(CGPoint)centerPoint;
-(SCD_Struct_IG30)centerCoordinate;
-(void)sort;
-(void)setCenterCoordinate:(SCD_Struct_IG30)arg1 ;
