...
@interface IGQuadtreeCluster : NSObject {
	...
	SCD_Struct_IG36 _centerCoordinate;
...
@property (assign,nonatomic) SCD_Struct_IG36 centerCoordinate;              //@synthesize centerCoordinate=_centerCoordinate - In the implementation block
...
-(int)numPoints;
-(SCD_Struct_IG37)boundingRegion;
-(id)init;
...
-(CGPoint)centerPoint;
-(SCD_Struct_IG36)centerCoordinate;
-(void)sort;
-(void)setCenterCoordinate:(SCD_Struct_IG36)arg1 ;
