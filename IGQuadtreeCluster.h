...
@interface IGQuadtreeCluster : NSObject {
	...
	SCD_Struct_IG116 _centerCoordinate;
...
@property (assign,nonatomic) SCD_Struct_IG116 centerCoordinate;              //@synthesize centerCoordinate=_centerCoordinate - In the implementation block
...
-(int)numPoints;
-(SCD_Struct_IG118)boundingRegion;
-(id)init;
...
-(CGPoint)centerPoint;
-(SCD_Struct_IG116)centerCoordinate;
-(void)sort;
-(void)setCenterCoordinate:(SCD_Struct_IG116)arg1 ;
