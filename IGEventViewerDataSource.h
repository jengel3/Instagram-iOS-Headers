...
@property (assign,nonatomic,__weak) id<IGFeedItemHeaderDelegate> headerViewDelegate;                                //@synthesize headerViewDelegate=_headerViewDelegate - In the implementation block
...
-(void)setHeaderViewDelegate:(id<IGFeedItemHeaderDelegate>)arg1 ;
