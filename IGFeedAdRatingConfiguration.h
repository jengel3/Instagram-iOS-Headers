...
@class IGFeedMainConfiguration, NSString;

@interface IGFeedAdRatingConfiguration : NSObject <IGFeedConfigurationType> {

	IGFeedMainConfiguration* _defaultConfig;

}

@property (nonatomic,readonly) IGFeedMainConfiguration * defaultConfig;              //@synthesize defaultConfig=_defaultConfig - In the implementation block
...
-(id)init;
-(IGFeedMainConfiguration *)defaultConfig;
@end
