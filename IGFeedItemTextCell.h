...
@class IGFeedItem, IGCoreTextView, IGStyledString, NSString, UINavigationController, UIImageView, UILabel, IGAppInstallationsHelper;
...
-(void)setFeedItem:(id)arg1 delegate:(id)arg2 loggingDelegate:(id)arg3 navigationController:(id)arg4 textHorizontalPadding:(float)arg5 styledString:(id)arg6 cellType:(int)arg7 showTimeStamp:(char)arg8 accessibilityLabel:(id)arg9 enableTapToViewComments:(char)arg10 ;
