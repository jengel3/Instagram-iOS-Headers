...
@interface IGFeedCollectionViewLayoutDataSource : NSObject <IGCollectionViewLayoutDataSource> {
	...
	char _dataSourceRespondsToPrepareContextForObjects;
...
@property (nonatomic,readonly) char dataSourceRespondsToPrepareContextForObjects;                         //@synthesize dataSourceRespondsToPrepareContextForObjects=_dataSourceRespondsToPrepareContextForObjects - In the implementation block
@property (readonly) unsigned hash; 
@property (readonly) Class superclass; 
@property (copy,readonly) NSString * description; 
@property (copy,readonly) NSString * debugDescription; 
-(char)dataSourceRespondsToPrepareContextForObjects;
