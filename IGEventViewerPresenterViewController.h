...
-(id)initWithEventService:(id)arg1 soundStateListener:(id)arg2 logger:(id)arg3 focusCoordinator:(id)arg4 initialPosts:(id)arg5 ;
...
-(void)didDismissEventViewerViewController:(id)arg1 withLastSeenPost:(id)arg2 ;
-(void)soundListenerDidUpdate:(id)arg1 ;
-(id)initWithConfiguration:(id)arg1 focusCoordinator:(id)arg2 initialPosts:(id)arg3 ;
