...
@class NSString, NSArray, IGDirectShareRecipient, UIView, UICollectionView, UIButton, UILabel, UITextField, IGDirectGrowingMessageTextView, UITextView, IGDirectRecipientDataSource, IGSwipeDismissManager;
