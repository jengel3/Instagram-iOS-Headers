...
@class NSString, IGListItemController, IGLabelItemConfiguration;
...
-(id)initWithListItemController:(id)arg1 collectionContext:(id)arg2 labelItemConfiguration:(id)arg3 ;
