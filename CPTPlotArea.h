...
@interface CPTPlotArea : CPTAnnotationHostLayer {
	...
	SCD_Struct_CP82 widthDecimal;
	SCD_Struct_CP82 heightDecimal;
...
@property (assign,nonatomic) SCD_Struct_CP82 widthDecimal; 
@property (assign,nonatomic) SCD_Struct_CP82 heightDecimal; 
...
-(void)setWidthDecimal:(SCD_Struct_CP82)arg1 ;
-(void)setHeightDecimal:(SCD_Struct_CP82)arg1 ;
