...
@property (assign,getter=isLongcatEnabled,nonatomic) char longcatEnabled;                                       //@synthesize isLongcatEnabled=_isLongcatEnabled - In the implementation block
