...
@protocol IGNavigationContext, IGPresentationContext, IGListAdapterDataSource, IGListAdapterDelegate, UICollectionViewDelegate, UIScrollViewDelegate, IGListUpdatingDelegate;
