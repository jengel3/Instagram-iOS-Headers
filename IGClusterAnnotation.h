...
@interface IGClusterAnnotation : NSObject <MKAnnotation> {
	...
	SCD_Struct_IG36 _coordinateOfPreviousAnnotation;
...
@property (assign,nonatomic) SCD_Struct_IG36 coordinateOfPreviousAnnotation;              //@synthesize coordinateOfPreviousAnnotation=_coordinateOfPreviousAnnotation - In the implementation block
...
-(SCD_Struct_IG36)coordinateOfPreviousAnnotation;
-(void)setHasPreviousAnnotaton:(char)arg1 ;
-(void)setCoordinateOfPreviousAnnotation:(SCD_Struct_IG36)arg1 ;
