...
@interface IGClusterAnnotation : NSObject <MKAnnotation> {
	...
	SCD_Struct_IG26 _coordinateOfPreviousAnnotation;
...
@property (assign,nonatomic) SCD_Struct_IG26 coordinateOfPreviousAnnotation;              //@synthesize coordinateOfPreviousAnnotation=_coordinateOfPreviousAnnotation - In the implementation block
...
-(SCD_Struct_IG26)coordinateOfPreviousAnnotation;
-(void)setCoordinateOfPreviousAnnotation:(SCD_Struct_IG26)arg1 ;
