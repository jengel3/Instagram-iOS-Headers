...
-(unsigned)clipIndexForFrameTime:(SCD_Struct_IG43)arg1 ;
-(SCD_Struct_IG43)convertPresentationTime:(SCD_Struct_IG43)arg1 toClip:(id)arg2 ;
-(CGImageRef)generator:(id)arg1 generateImageForTimestamp:(SCD_Struct_IG43*)arg2 ;
...
-(char)shouldStabilizeFrameAtTime:(SCD_Struct_IG43)arg1 ;
