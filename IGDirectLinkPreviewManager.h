...
@class NSString, NSArray, IGButton, IGDirectLinkPreview, IGMediaRequestController;

@interface IGDirectLinkPreviewManager : NSObject <IGMediaRequestControllerDelegate> {
