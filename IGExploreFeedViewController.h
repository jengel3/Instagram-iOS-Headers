...
@class NSArray, IGExploreMarqueeItem, IGExploreTTILogger, IGFeedStatusView, UIActivityIndicatorView, IGPullToRefreshViewManager, UICollectionView, NSMutableSet, NSString;
