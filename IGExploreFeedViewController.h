...
@class NSArray, IGExploreTTILogger, IGFeedStatusView, UIActivityIndicatorView, IGRefreshControl, UICollectionView, NSMutableSet, IGFeedItemPreviewingHandler, NSString, UIView;
