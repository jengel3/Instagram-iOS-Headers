...
@class NSArray, IGExploreMarqueeItem, IGExploreTTILogger, IGFeedStatusView, UIActivityIndicatorView, IGPullToRefreshViewManager, UICollectionView, UIView, NSMutableSet, IGFeedItemPreviewingHandler, NSString;

@interface IGExploreFeedViewController : IGViewController <UICollectionViewDataSource, UICollectionViewDelegate, IGPullToRefreshProtocol, UICollectionViewDelegateFlowLayout, IGExploreCellDelegate, IGFeedStatusViewDelegate, IGMarqueeAttributionViewDelegate> {
