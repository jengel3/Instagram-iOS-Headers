...
@class UITableView, UIVisualEffectView, UIActivityIndicatorView, NSObject, PHAssetCollection, PHFetchResult, NSMutableDictionary, PHCachingImageManager, PHImageRequestOptions, ALAssetsLibrary, NSArray, UIView, NSString;
...
@property (assign,nonatomic) int selectAlbumAppearanceType;                            //@synthesize selectAlbumAppearanceType=_selectAlbumAppearanceType - In the implementation block
