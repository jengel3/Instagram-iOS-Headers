...
-(id)initWithMedia:(id)arg1 sectionNumber:(long long)arg2 position:(id)arg3 algorithm:(id)arg4 viewed:(char)arg5 subImpression:(char)arg6 clusterKey:(id)arg7 sectionType:(int)arg8 ;
