...
-(SCD_Struct_CP96)lengthInPlotCoordinates:(SCD_Struct_CP96)arg1 ;
-(void)drawBarInContext:(CGContextRef)arg1 recordIndex:(unsigned)arg2 ;
-(float)lengthInView:(SCD_Struct_CP96)arg1 ;
...
-(double)doubleLengthInPlotCoordinates:(SCD_Struct_CP96)arg1 ;
