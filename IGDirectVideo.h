...
@class IGDirectContentUploadInfo, NSString, IGUploadModel, NSData, NSArray, IGVideo, NSValue, IGPhoto, NSURL;

@interface IGDirectVideo : IGDirectContent <IGDirectCommentable, IGDirectContentFirstAppearance, IGDirectContentMediaUploadable, IGDirectContentReactable, IGDirectMediaContent, NSCoding> {
