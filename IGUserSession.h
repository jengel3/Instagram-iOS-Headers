...
@class NSString, IGNonCurrentUserDefaults, IGAutocompleteHashtagsStore, IGAutocompletePlacesStore, IGAutocompleteUsersStore, IGBlendedSearchRecentItemsOrderStore, IGDirectThreadStore, IGDirectRecipientManager, IGFlaggedCommentLedger, IGRealtimeClient, IGServiceManager, IGHiddenSearchItemStore, IGWebViewProcessPoolContainer;
