...
@class IGVideoIndicatorView, UIView, IGPhoto, IGVideo, IGPost, IGImageProgressView, UITapGestureRecognizer, UILongPressGestureRecognizer, IGVideoLoadProgressView, NSNumber, IGAudioNUXController, IGFeedVideoPlayer, NSString;
