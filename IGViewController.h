...
@class UIBarButtonItem, IGAnalyticsMetadata, NSString, IGRaindropRankInfo, IGRaindropNavState, IGKeyboardManager, IGNavigationController, IGTabBarController, IGRaindropNavEvent;
