...
@class IGAnalyticsMetadata, IGRaindropNavEvent, IGRaindropRankInfo, UIBarButtonItem, NSString, IGRaindropNavState, IGKeyboardManager, IGNavigationController, IGTabBarController;
