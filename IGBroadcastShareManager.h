...
@property (assign,nonatomic) char showNewLocationUI;                                                 //@synthesize showNewLocationUI=_showNewLocationUI - In the implementation block
...
-(void)setShowNewLocationUI:(char)arg1 ;
