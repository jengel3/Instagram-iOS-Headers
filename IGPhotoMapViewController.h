...
@interface IGPhotoMapViewController : IGViewController <MKMapViewDelegate, IGPhotoMapDataSourceDelegate, IGEditBubbleAnnotationDelegate, UIGestureRecognizerDelegate, IGPhotoMapGridviewOverlayDelegate, IGClusterAnnotationViewDelegate, IGPhotoMapReviewDelegate, IGPhotoMapEditManagerDelegate> {
	...
	SCD_Struct_IG27 _lastZoomedRegion;
	...
	SCD_Struct_IG25 _previousCoordinate;
	SCD_Struct_IG27 _previousRegion;
...
-(SCD_Struct_IG27)defaultMapRegion;
-(char)isInReviewMode;
-(void)initializeMap;
-(void)removeCalloutAnnotation:(char)arg1 ;
-(void)toggleZoomOutButton;
-(double)distanceOfRegionSpan:(SCD_Struct_IG27)arg1 ;
-(SCD_Struct_IG27)getExpandedMapRegion;
...
-(void)setRegionAndRecordZoomHistory:(SCD_Struct_IG27)arg1 animated:(char)arg2 ;
-(void)setSearchResultsAfterComputingThemAsynchronously:(id)arg1 ;
-(char)canZoomToRegion:(SCD_Struct_IG27)arg1 ;
-(SCD_Struct_IG27)region:(SCD_Struct_IG27)arg1 withPadding:(UIEdgeInsets)arg2 ;
...
-(SCD_Struct_IG27)adjustRegionToRespectMaximumZoom:(SCD_Struct_IG27)arg1 ;
-(void)enableEditMode;
...
-(IGUser *)user;
-(SCD_Struct_IG27)mapRectForRect:(CGRect)arg1 ;
