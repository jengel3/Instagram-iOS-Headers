...
@interface IGPhotoMapViewController : IGViewController <MKMapViewDelegate, IGPhotoMapDataSourceDelegate, IGEditBubbleAnnotationDelegate, UIGestureRecognizerDelegate, IGPhotoMapGridviewOverlayDelegate, IGClusterAnnotationViewDelegate, IGPhotoMapReviewDelegate, IGPhotoMapEditManagerDelegate> {
	...
	SCD_Struct_IG28 _lastZoomedRegion;
	...
	SCD_Struct_IG26 _previousCoordinate;
	SCD_Struct_IG28 _previousRegion;
...
-(SCD_Struct_IG28)defaultMapRegion;
-(char)isInReviewMode;
-(void)initializeMap;
-(void)removeCalloutAnnotation:(char)arg1 ;
-(void)toggleZoomOutButton;
-(double)distanceOfRegionSpan:(SCD_Struct_IG28)arg1 ;
-(SCD_Struct_IG28)getExpandedMapRegion;
...
-(void)setRegionAndRecordZoomHistory:(SCD_Struct_IG28)arg1 animated:(char)arg2 ;
-(char)canZoomToRegion:(SCD_Struct_IG28)arg1 ;
-(SCD_Struct_IG28)region:(SCD_Struct_IG28)arg1 withPadding:(UIEdgeInsets)arg2 ;
...
-(IGUser *)user;
-(SCD_Struct_IG28)mapRectForRect:(CGRect)arg1 ;
