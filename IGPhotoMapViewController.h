...
@interface IGPhotoMapViewController : IGViewController <MKMapViewDelegate, IGPhotoMapDataSourceDelegate, IGEditBubbleAnnotationDelegate, UIGestureRecognizerDelegate, IGPhotoMapGridviewOverlayDelegate, IGClusterAnnotationViewDelegate, IGPhotoMapReviewDelegate, IGPhotoMapEditManagerDelegate> {
	...
	SCD_Struct_IG118 _lastZoomedRegion;
	...
	SCD_Struct_IG116 _previousCoordinate;
	SCD_Struct_IG118 _previousRegion;
...
-(SCD_Struct_IG118)defaultMapRegion;
-(void)initializeMap;
-(void)removeCalloutAnnotation:(char)arg1 ;
-(void)toggleZoomOutButton;
-(double)distanceOfRegionSpan:(SCD_Struct_IG118)arg1 ;
-(SCD_Struct_IG118)getExpandedMapRegion;
...
-(void)setRegionAndRecordZoomHistory:(SCD_Struct_IG118)arg1 animated:(char)arg2 ;
-(char)canZoomToRegion:(SCD_Struct_IG118)arg1 ;
-(SCD_Struct_IG118)region:(SCD_Struct_IG118)arg1 withPadding:(UIEdgeInsets)arg2 ;
...
-(IGUser *)user;
-(void)showEditButton;
-(SCD_Struct_IG118)mapRectForRect:(CGRect)arg1 ;
