...
@interface IGPhotoMapViewController : IGViewController <MKMapViewDelegate, IGPhotoMapDataSourceDelegate, IGEditBubbleAnnotationDelegate, UIGestureRecognizerDelegate, IGPhotoMapGridviewOverlayDelegate, IGClusterAnnotationViewDelegate, IGPhotoMapReviewDelegate, IGPhotoMapEditManagerDelegate> {
	...
	SCD_Struct_IG42 _lastZoomedRegion;
	...
	SCD_Struct_IG40 _previousCoordinate;
	SCD_Struct_IG42 _previousRegion;
...
-(SCD_Struct_IG42)defaultMapRegion;
-(char)isInReviewMode;
-(void)initializeMap;
-(void)removeCalloutAnnotation:(char)arg1 ;
-(void)toggleZoomOutButton;
-(double)distanceOfRegionSpan:(SCD_Struct_IG42)arg1 ;
-(SCD_Struct_IG42)getExpandedMapRegion;
...
-(void)setRegionAndRecordZoomHistory:(SCD_Struct_IG42)arg1 animated:(char)arg2 ;
-(void)setSearchResultsAfterComputingThemAsynchronously:(id)arg1 ;
-(char)canZoomToRegion:(SCD_Struct_IG42)arg1 ;
-(SCD_Struct_IG42)region:(SCD_Struct_IG42)arg1 withPadding:(UIEdgeInsets)arg2 ;
...
-(SCD_Struct_IG42)adjustRegionToRespectMaximumZoom:(SCD_Struct_IG42)arg1 ;
-(void)enableEditMode;
-(void)setHasPermanentlyDeletedMedia:(char)arg1 ;
-(void)setIsInReviewMode:(char)arg1 ;
-(IGQuadtree *)quadtree;
-(id)initWithUser:(id)arg1 ;
-(SCD_Struct_IG42)mapRectForRect:(CGRect)arg1 ;
