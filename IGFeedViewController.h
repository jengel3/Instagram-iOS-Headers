...
@interface IGFeedViewController : IGFeedNetworkSourceViewController <IGFeedPhotoViewDelegate, IGFeedPromotionBannerDelegate, IGUserInTagDisplayDelegate, IGFeedItemVideoCellDelegate, IGFeedItemPageCellDelegate, IGItemVisibilityTrackerDelegate, IGFeedItemLoggingProviderDelegate, IGModernWebViewControllerDelegate, IGFeedItemActionCellDelegate, IGFeedItemAppHeaderDelegate, IGFeedItemHeaderDelegate, IGFeedItemTextCellDelegate, IGBugReportingProtocol, IGFeedCollectionViewLayoutDelegate, IGRaindropAnalyticsDelegate> {
...
-(char)allowSponsoredAppForFeedItem:(id)arg1 withDirectResponseInfo:(id)arg2 ;
-(char)allowDirectResponseForFeedItem:(id)arg1 withDirectResponseInfo:(id)arg2 ;
...
-(void)openStoreProductInfoForFeedItem:(id)arg1 withDirectResponseInfo:(id)arg2 context:(id)arg3 ;
...
-(id)openAppLinkForFeedItem:(id)arg1 withDirectResponseInfo:(id)arg2 ;
