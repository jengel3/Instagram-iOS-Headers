...
@class IGFeedViewController, IGUserPreviewingHandler, IGHashtagPreviewingHandler, NSString;

@interface IGFeedPreviewingHandler : NSObject <UIViewControllerPreviewingDelegate> {

	IGFeedViewController* _controller;
...
@property (assign,nonatomic,__weak) IGFeedViewController * controller;                         //@synthesize controller=_controller - In the implementation block
...
-(IGFeedViewController *)controller;
-(void)setController:(IGFeedViewController *)arg1 ;
@end
