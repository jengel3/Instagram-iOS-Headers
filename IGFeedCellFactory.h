...
+(void)configureFeedCell:(id)arg1 forCellType:(int)arg2 feedItem:(id)arg3 indexPath:(id)arg4 collectionView:(id)arg5 imageSizeForGrid:(CGSize)arg6 context:(id)arg7 feedConfiguration:(id)arg8 usesIgCollectionLayout:(char)arg9 controller:(id)arg10 navigationController:(id)arg11 pageCellState:(id)arg12 albumFocusCoordinator:(id)arg13 presentationContext:(id)arg14 albumCellDelegate:(id)arg15 pageCellDelegate:(id)arg16 photoCellDelegate:(id)arg17 tagViewDelegate:(id)arg18 videoCellPlayerDelegate:(id)arg19 videoCellAnalyticsDelegate:(id)arg20 videoCellInteractionDelegate:(id)arg21 textCellDelegate:(id)arg22 loggingDelegate:(id)arg23 directResponseLoggingDelegate:(id)arg24 actionCellDelegate:(id)arg25 pivotCellDelegate:(id)arg26 ;
