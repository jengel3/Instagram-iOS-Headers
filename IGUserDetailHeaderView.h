...
@class IGUserDetailViewController, IGUser, NSDictionary, IGProfilePictureImageView, IGStatButton, IGButton, UIImageView, IGFollowButton, IGFriendRequestHeaderView, IGCoreTextView, UIView, IGFeedToggleView, IGProfilePictureHelper, IGSimilarAccountsControl, IGSimilarAccountsView, IGProfileMegaphoneView, UIActivityIndicatorView, UITapGestureRecognizer, IGSpringButton, NSArray, NSString;
