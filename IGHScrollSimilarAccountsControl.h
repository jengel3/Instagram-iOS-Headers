...
@class NSArray, IGListAdapter, IGListAdapterUpdaterLogger, IGListCollectionView, IGUser, IGProfileChainingLogger, NSString;
...
@property (nonatomic,readonly) IGProfileChainingLogger * logger;                            //@synthesize logger=_logger - In the implementation block
...
-(IGProfileChainingLogger *)logger;
-(IGUser *)user;
-(void)dealloc;
-(id)init;
