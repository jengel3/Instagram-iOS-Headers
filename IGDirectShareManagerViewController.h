...
@class NSString, UIScrollView, UIViewController, IGAnalyticsMetadata, IGRaindropNavEvent, IGMutableRaindropRankInfo, IGRaindropNavState, IGMediaMetadata, UIView, NSOrderedSet, IGDirectThread, IGUserListNetworkDataSource, IGUserListLocalDataSource, IGTokenField, NSArray;

@interface IGDirectShareManagerViewController : UITableViewController <UITableViewDataSource, UITableViewDelegate, IGTextFieldDelegate, IGTokenFieldDelegate, IGUserListNetworkDataSourceDelegate, IGShareManager, IGAnalyticsRaindropProtocol> {
