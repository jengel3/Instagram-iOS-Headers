...
-(void)logRaindropMarqueeImpressionEventWithNavState:(id)arg1 marquee:(id)arg2 sectionNumber:(id)arg3 position:(id)arg4 algorithm:(id)arg5 viewed:(char)arg6 subImpression:(char)arg7 clusterKey:(id)arg8 ;
-(void)logRaindropTagImpressionEventWithNavState:(id)arg1 tag:(id)arg2 sectionNumber:(id)arg3 position:(id)arg4 algorithm:(id)arg5 viewed:(char)arg6 subImpression:(char)arg7 clusterKey:(id)arg8 ;
...
-(void)logRaindropPhotoImpressionWithNavState:(id)arg1 media:(id)arg2 sectionNumber:(id)arg3 algorithm:(id)arg4 viewed:(char)arg5 subImpression:(char)arg6 position:(id)arg7 clusterKey:(id)arg8 ;
