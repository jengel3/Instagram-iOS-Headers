...
-(void)logRaindropMarqueeClickEventWithNavState:(id)arg1 sectionType:(int)arg2 marquee:(id)arg3 sectionNumber:(id)arg4 position:(id)arg5 algorithm:(id)arg6 clusterKey:(id)arg7 ;
-(void)logRaindropTagClickEventWithNavState:(id)arg1 sectionType:(int)arg2 tag:(id)arg3 sectionNumber:(id)arg4 position:(id)arg5 algorithm:(id)arg6 clusterKey:(id)arg7 ;
-(void)logRaindropMarqueeImpressionEventWithNavState:(id)arg1 sectionType:(int)arg2 marquee:(id)arg3 sectionNumber:(id)arg4 position:(id)arg5 algorithm:(id)arg6 viewed:(char)arg7 subImpression:(char)arg8 clusterKey:(id)arg9 ;
-(void)logRaindropTagImpressionEventWithNavState:(id)arg1 sectionType:(int)arg2 tag:(id)arg3 sectionNumber:(id)arg4 position:(id)arg5 algorithm:(id)arg6 viewed:(char)arg7 subImpression:(char)arg8 clusterKey:(id)arg9 ;
-(void)logRaindropUserImpressionEventWithNavState:(id)arg1 user:(id)arg2 sectionNumber:(id)arg3 position:(id)arg4 algorithm:(id)arg5 viewed:(char)arg6 subImpression:(char)arg7 clusterKey:(id)arg8 ;
-(void)logRaindropPlaceImpressionEventWithNavState:(id)arg1 place:(id)arg2 sectionNumber:(id)arg3 position:(id)arg4 algorithm:(id)arg5 viewed:(char)arg6 subImpression:(char)arg7 clusterKey:(id)arg8 ;
...
-(void)logFollowEventWithNavState:(id)arg1 isFollow:(char)arg2 targetUserId:(id)arg3 position:(id)arg4 algorithm:(id)arg5 clickPoint:(id)arg6 sectionNumber:(id)arg7 clusterKey:(id)arg8 ;
...
-(void)logRaindropPhotoImpressionWithNavState:(id)arg1 sectionType:(int)arg2 media:(id)arg3 sectionNumber:(id)arg4 algorithm:(id)arg5 viewed:(char)arg6 subImpression:(char)arg7 position:(id)arg8 clusterKey:(id)arg9 ;
-(void)logRaindropPhotoClickWithNavState:(id)arg1 sectionType:(int)arg2 media:(id)arg3 sectionNumber:(id)arg4 position:(id)arg5 algorithm:(id)arg6 clusterKey:(id)arg7 ;
...
-(void)logRaindropExploreSearchViewResultWithNavState:(id)arg1 searchQueryText:(id)arg2 searchType:(int)arg3 selectedUserId:(id)arg4 selectedHashtag:(id)arg5 numOfViewedResults:(id)arg6 localResult:(char)arg7 cachedSearchedResult:(char)arg8 selectedPlace:(id)arg9 resultsList:(id)arg10 requestId:(id)arg11 selectedPosition:(id)arg12 ;
...
-(void)logRaindropSearchClickWithNavState:(id)arg1 isTypeahead:(char)arg2 nullState:(char)arg3 searchQueryText:(id)arg4 object:(id)arg5 selectedPosition:(id)arg6 isLocalResult:(char)arg7 isFollow:(char)arg8 ;
...
-(void)logRaindropLikeEventWithNavState:(id)arg1 isLike:(char)arg2 mediaId:(id)arg3 isDoubleTap:(char)arg4 mediaOwnerId:(id)arg5 isFollow:(char)arg6 algorithm:(id)arg7 position:(id)arg8 ;
