...
-(void)logRaindropPlaceImpressionEventWithNavState:(id)arg1 place:(id)arg2 placeId:(id)arg3 sectionNumber:(id)arg4 position:(id)arg5 algorithm:(id)arg6 viewed:(char)arg7 subImpression:(char)arg8 clusterKey:(id)arg9 ;
...
-(void)logRaindropPlaceClickEventWithNavState:(id)arg1 place:(id)arg2 placeId:(id)arg3 sectionNumber:(id)arg4 position:(id)arg5 algorithm:(id)arg6 clusterKey:(id)arg7 ;
...
-(void)logRaindropPhotoClickWithNavState:(id)arg1 sectionType:(int)arg2 media:(id)arg3 sectionNumber:(id)arg4 position:(id)arg5 algorithm:(id)arg6 clusterKey:(id)arg7 rankToken:(id)arg8 ;
...
-(void)logRaindropSearchClickWithNavState:(id)arg1 isTypeahead:(char)arg2 nullState:(char)arg3 searchQueryText:(id)arg4 object:(id)arg5 selectedPosition:(id)arg6 isLocalResult:(char)arg7 isFollow:(char)arg8 resultsList:(id)arg9 ;
...
-(void)logRaindropLikeEventWithNavState:(id)arg1 isLike:(char)arg2 mediaId:(id)arg3 isDoubleTap:(char)arg4 mediaOwnerId:(id)arg5 isFollow:(char)arg6 algorithm:(id)arg7 position:(id)arg8 rankToken:(id)arg9 ;
