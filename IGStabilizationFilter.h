...
@interface IGStabilizationFilter : IGGLFilter {
	...
	float _zoom;
	NSData* _frameWarp;
	SCD_Struct_IG70 _cameraParameters;

}

@property (assign,nonatomic) SCD_Struct_IG70 cameraParameters;              //@synthesize cameraParameters=_cameraParameters - In the implementation block
...
-(void)setCameraParameters:(SCD_Struct_IG70)arg1 ;
...
-(SCD_Struct_IG70)cameraParameters;
-(NSData *)frameWarp;
-(id)init;
