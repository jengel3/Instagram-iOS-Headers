...
@class IGAnalyticsMetadata, IGRaindropNavEvent, IGMutableRaindropRankInfo, NSString, UIScrollView, UIViewController, IGRaindropNavState, IGMediaMetadata, UIView, NSOrderedSet, IGDirectThread, IGDirectRecipientDataSource, IGTokenField, NSArray, NSMutableDictionary;
